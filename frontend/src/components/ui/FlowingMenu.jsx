...
function MenuItem({ link, text, image, speed, textColor, marqueeBgColor, marqueeTextColor, borderColor, onItemClick }) {
  ...
  useEffect(() => {
    ...
    if (marqueeInnerRef.current) {
      ...
      observer.observe(marqueeInnerRef.current);
    }
  ...
  const handleClick = (e) => {
    ...
    if (link.startsWith('#')) {
      ...
      const sections = ['problem', 'how-it-works', 'tech']; // Known IDs to indices
      const index = sections.indexOf(targetId) + 1; // +1 because hero is 0
